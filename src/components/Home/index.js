...
class Home extends Component {
  ...
  getGitHubUserProfileDetails = async () => {
    ...
    const GitHubUserProfileUrl = `https://apis2.ccbp.in/gpv/profile-details/${username}?api_key=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`
    const options = {
      method: 'GET',
    }
    ...
    return (
      <div className="profileDetailsContainer">
        ...
        <div className="bottom-container">
          ...
          <div className="company-container">
            <h1 className="company-heading">Location</h1>
            <div className="companyUrl">
              <RiBuildingLine className="icon-style" />
          ...
          return (
            <>
              ...
              <div className="home-container">
                ...
                {isError && <p className="inputErrorMsg">{errorMsg}</p>}
