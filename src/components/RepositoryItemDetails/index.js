...
class RepositoryItemDetails extends Component {
  ...
  getGitHubUserRepositoryItemDetails = async () => {
    ...
    const url = `https://apis2.ccbp.in/gpv/specific-repo/${username}/${repoName}?api_key=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`
    const options = {
      method: 'GET',
    }
        ...
        <div className="repositoryItemContainer1">
          ...
          <div className="commit-issues-count-container">
            <div className="repo-item-counts-container">
              <h1 className="repo-item-count-heading">Commits Count</h1>
              <p className="repo-item-counts">{commitsCount}</p>
            </div>
            <div className="repo-item-counts-container">
              <h1 className="repo-item-count-heading">Issues Count</h1>
